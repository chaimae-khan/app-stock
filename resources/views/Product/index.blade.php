...
<div class="content">
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalAddProduct">
                <i class="fa-solid fa-plus"></i> Ajoute produit
            </a>
        </div>	
    ...
    <!-- Add Category Modal -->
    <div class="modal fade" id="ModalAddProduct" tabindex="-1" aria-labelledby="ModalAddCategoryLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalAddCategoryLabel">Ajoute nouveau produit</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <ul class="validationAddCategory"></ul>
                        <form action="{{ route('products.store') }}" id="FormAddProduct">
                            {{-- @csrf --}}
